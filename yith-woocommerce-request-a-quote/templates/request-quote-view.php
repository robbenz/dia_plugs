...
?>
	<p><?php //  _e('Your quote is currently empty, <a href="https://diamedicalusa.com/medical-equipment/">Click Here</a> to get started', 'ywraq') ?></p>
	...
	<table class="shop_table cart" id="yith-ywrq-table-list" cellspacing="0">
        <thead>
            <tr>
                ...
                <th class="product-unit-price"><?php _e( 'Unit Price', 'ywraq' ); ?></th>
