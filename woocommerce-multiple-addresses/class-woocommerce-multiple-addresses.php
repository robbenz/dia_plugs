	...
	public function multiple_shipping_addresses() {
		...
		if ( ! empty( $otherAddr ) ) {
			...
			foreach ( $otherAddr as $idx => $address ) {
				...
				echo '<p align="right"><a href="#" class="delete">' . __( 'Delete This Address', $this->plugin_slug ) . '</a></p>';
		...
		?>
		<script type="text/javascript">
			var tmpl = '<div class="shipping_address address_block"><p align="right"><a href="#" class="delete">Delete This Address</a></p>';
