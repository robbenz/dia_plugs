...
<?php
/*-----------------------------------------------------------------------------------
WC Predictive Search Google Analytics Tab
...
class WC_Predictive_Search_Google_Analytics_Tab extends WC_Predictive_Search_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'wc_predictive_search_google_analytics_tab_manager',
		);
...
global $wc_predictive_search_google_analytics_tab;
$wc_predictive_search_google_analytics_tab = new WC_Predictive_Search_Google_Analytics_Tab();

/** 
 * wc_admin_ei_email_popup_tab_manager()
 * Define the callback function to show tab content
 */
function wc_predictive_search_google_analytics_tab_manager() {
	global $wc_predictive_search_google_analytics_tab;
	$wc_predictive_search_google_analytics_tab->tab_manager();
}
