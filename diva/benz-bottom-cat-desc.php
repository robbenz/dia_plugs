...
function benz_taxonomy_edit_meta_field($term) {
	...
	<tr class="form-field">
	<th scope="row" valign="top"><label style="font-weight:800; font-size:1.4em;" for="term_meta[custom_term_meta]"><?php _e( 'Bottom Description', 'benz' ); ?></label></th>
		<td>
            <input type="text" style="width:100%;" name="term_meta[custom_term_meta]" id="term_meta[custom_term_meta]" class="megan-isa-diva" value="<?php echo esc_attr( $term_meta['custom_term_meta'] ) ? esc_attr( $term_meta['custom_term_meta'] ) : ''; ?>">
			<p class="description"><?php _e( 'This will go underneath the gallery pages. Because I said so','benz' ); ?></p>
		</td>
	</tr>
<?php
