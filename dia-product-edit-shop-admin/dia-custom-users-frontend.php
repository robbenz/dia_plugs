<?php
// add to galery page
add_action( 'woocommerce_after_shop_loop_item', 'dia_user_admin_galpage' );
add_action( 'woocommerce_product_thumbnails', 'dia_user_admin_galpage' );
function dia_user_admin_galpage() {
  global $product;
