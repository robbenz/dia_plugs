...
(function(factory) {
    ...
    function Plugin(element, options, objD) {
        ...
        this.options = $.extend({}, defaults, options, objD ); // muro (added objD)
        ...
        if (options === undefined || typeof options === "object") {
            return this.each(function() {
                if (!$.data(this, "plugin_" + pluginName)) {
	                var objD = $(this).data();
                    $.data(this, "plugin_" + pluginName, new Plugin(this, options, objD)); // muro (added objD)
                }
            });
