...
class WC_Email_Inquiry_MetaBox
{
        ...
        <table cellspacing="0" class="form-table">
			<tbody>
                ...
                <tr valign="top">
                    ...
                    <td class="forminp"><label><input type="checkbox" name="_wc_email_inquiry_settings_custom[wc_email_inquiry_hide_price]" id="wc_email_inquiry_hide_price" value="yes"  <?php checked( $wc_email_inquiry_hide_price, 'yes' ); ?> /> <?php _e('ON', 'wc_email_inquiry'); ?></label>
                    </td>
               	</tr>
                <tr valign="top">
                    ...
                    <td class="forminp">
                    	<label><input class="wc_ei_rule_after_login" type="checkbox" name="_wc_email_inquiry_settings_custom[wc_email_inquiry_hide_price_after_login]" id="wc_email_inquiry_hide_price_after_login" value="yes" <?php checked( $wc_email_inquiry_hide_price_after_login, 'yes' ); ?> /> <?php _e('ON', 'wc_email_inquiry'); ?></label>
	...
	public static function save_meta_boxes($post_id){
		...
		if ($post_type == 'product' && isset($_REQUEST['_wc_email_inquiry_settings_custom']) && $post_status != false  && $post_status != 'inherit') {
			...
			if ( !isset($wc_email_inquiry_settings_custom['wc_email_inquiry_hide_addcartbt_after_login'] ) ) {
				$wc_email_inquiry_settings_custom['wc_email_inquiry_hide_addcartbt_after_login'] = 'no' ;
			}
			...
			if ( !isset($wc_email_inquiry_settings_custom['wc_email_inquiry_show_button_after_login'] ) ) {
				$wc_email_inquiry_settings_custom['wc_email_inquiry_show_button_after_login'] = 'no' ;
			}
			...
			if ( !isset($wc_email_inquiry_settings_custom['wc_email_inquiry_hide_price_after_login'] ) ) {
				$wc_email_inquiry_settings_custom['wc_email_inquiry_hide_price_after_login'] = 'no' ;
			}
