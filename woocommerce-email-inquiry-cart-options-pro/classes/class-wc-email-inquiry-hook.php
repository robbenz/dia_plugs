...
class WC_Email_Inquiry_Hook_Filter
{
	...
	public static function add_email_inquiry_button($product_id, $page_type= 'single') {
		...
		if (trim($wc_email_inquiry_button_title) == '') $wc_email_inquiry_button_title = __('Request A Quote', 'wc_email_inquiry');
...
function ei_getWidth() {
	...
	public static function add_google_fonts() {
		...
		$google_fonts = array( 
			...
			global $wc_email_inquiry_customize_email_popup;
			$google_fonts[] = $wc_email_inquiry_customize_email_popup['inquiry_contact_heading_font']['face'];
			$google_fonts[] = $wc_email_inquiry_customize_email_popup['inquiry_form_product_name_font']['face'];
			$google_fonts[] = $wc_email_inquiry_customize_email_popup['inquiry_form_product_url_font']['face'];
			$google_fonts[] = $wc_email_inquiry_customize_email_popup['inquiry_contact_popup_text']['face'];
			$google_fonts[] = $wc_email_inquiry_customize_email_popup['inquiry_form_subject_font']['face'];
			$google_fonts[] = $wc_email_inquiry_customize_email_popup['inquiry_contact_button_font']['face'];
