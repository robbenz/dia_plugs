...
'delete' => '<a href="' . $delete_url . '">' . __( 'Remove from exclusions', 'yith-woocommerce-request-a-quote' ) . '</a>',
        ...
        if ( 'delete' === $table->current_action() ) {
            $message = sprintf( _n( '%s product removed successfully', '%s products removed successfully', count( $_GET['id'] ), 'yith-woocommerce-request-a-quote' ), count( $_GET['id'] ) );
        }
                    ...
                    $args = array(
                        ...
                        'tax_query'      => array(
                            array(
                                ...
                                'field'    => 'id',
                                'terms'    => explode( ',', $_POST['category_ids'] ),
                            ),
                        )
                    );
        ...
        if ( isset( $_GET['id'] ) && !empty( $_GET['action'] ) && ( 'edit' == $_GET['action'] ) ) {
            ...
            $item = array(
                'ID'                => $_GET['id'],
                'hide_add_to_quote' => get_post_meta( $_GET['id'], '_ywraq_hide_quote_button', true ),
            );
                    ...
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            ...
                            <td class="forminp forminp-checkbox">
                                <input id="hide-add-to-quote" name="hide_add_to_quote" type="checkbox" <?php checked( $item['hide_add_to_quote'], 1 ) ?> />
                            </td>
                        </tr>
                        </tbody>
                    </table>
