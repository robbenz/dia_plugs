...
echo sprintf( __( '%s n. %d', 'yith-woocommerce-request-a-quote' ), $email_title, $raq_data['order-number'] ) . "\n\n";
...
if ( ( $after_list = get_post_meta( $order->id, '_ywraq_request_response_after', true ) ) != '' ) {
	echo apply_filters( 'ywraq_quote_after_list', $after_list, $order->id ) . "\n\n";
}
