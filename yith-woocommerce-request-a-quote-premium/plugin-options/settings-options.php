...
$section1 = array(
    ...
    'show_btn_only_out_of_stock' => array(
        'name'    => __( 'Show button only for product out of stock', 'yith-woocommerce-request-a-quote' ),
        'desc'    => '',
...
if ( catalog_mode_plugin_enabled() ) {
    unset( $options['settings']['product_settings'] );
    unset( $options['settings']['hide_add_to_cart'] );
    unset( $options['settings']['hide_price'] );
    unset( $options['settings']['product_settings_end'] );
}
return $options;