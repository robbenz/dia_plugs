...
if ( defined( 'YITH_YWRAQ_VERSION' ) ) {
    ...
    define( 'YITH_YWRAQ_VERSION', '1.4.8' );
}
...
if ( ! function_exists( 'yith_ywraq_premium_constructor' ) ) {
    ...
    function yith_ywraq_premium_constructor() {
        ...
        if ( class_exists( 'WC_Composite_Products' ) ) {
            require_once( YITH_YWRAQ_INC . 'compatibility/class.woocommerce-composite-products.php' );
        }
        ...
        if ( is_admin() && ! ( defined( 'DOING_AJAX' ) && DOING_AJAX && isset( $_REQUEST['action'] ) &&
                               ( $_REQUEST['action'] == 'yith_load_product_quick_view' || $_REQUEST['action'] == 'yit_load_product_quick_view' ) )
        ) {
