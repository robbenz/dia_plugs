            ...
            if ( array_key_exists( 'composite_data', $raq[ $key ] ) ) {
                ...
                foreach ( $composite_data as $key => $cdata ){
                    ...
                    <tr>
                        ...
                        <td scope="col" style="text-align:left;"><?php echo apply_filters( 'yith_ywraq_hide_price_template' ,  ( $cdata['price']) ? __('Option subtotal: ', 'yith-woocommerce-request-a-quote') . wc_price( $cdata['price'] * $composite_quantity *  $cdata['quantity'] ) : '', $_product->id ); ?></td>
                    </tr>
<?php
